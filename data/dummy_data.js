...
export const MEALS = [
  new Meal(
    ...
    [
      'Este perfume pertenece a la familia olfativa Ámbar Amaderada, y fue lanzado en 2022 bajo la experta dirección de Quentin Bisch. Su cautivadora mezcla de ingredientes lo convierten en una opción perfecta para hombres que buscan una fragancia única y sofisticada.'
    ],
    false,
    true,
    true,
